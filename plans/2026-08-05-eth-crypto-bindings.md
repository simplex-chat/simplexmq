...
- **No signing and no stealth addresses.** This change derives keys and
  addresses. Signing, the EIP-712 typed-data hashing it requires, and stealth
...
`tests/CoreTests/EthCryptoTests.hs`, 72 examples, with published vectors:
