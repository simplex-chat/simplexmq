...
//adds the visual progress ring to the page, decides whether encryption progress should be shown based on file size, reserves part of the progress bar for encryption work, and updates the UI status text accordingly.
