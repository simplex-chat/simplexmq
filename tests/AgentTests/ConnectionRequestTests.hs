...
connectionRequestTests =
  describe "connection request parsing / serializing" $ do
    ...
    it "should serialize and parse connection invitations and contact addresses" $ do
      ...
      connectionRequestNoQM #==# ("simplex:/invitation#/?v=2-8&smp=" <> url queueStrNoQM <> "&e2e=" <> testE2ERatchetParamsStrUri)
      connectionRequest1 #==# ("simplex:/invitation#/?v=2-8&smp=" <> url queue1Str <> "&e2e=" <> testE2ERatchetParamsStrUri)
      connectionRequest2queues #==# ("simplex:/invitation#/?v=2-8&smp=" <> url (queueStr <> ";" <> queueStr) <> "&e2e=" <> testE2ERatchetParamsStrUri)
      connectionRequestNew #==# ("simplex:/invitation#/?v=2-8&smp=" <> url queueNewStr <> "&e2e=" <> testE2ERatchetParamsStrUri)
      connectionRequestNew1 #==# ("simplex:/invitation#/?v=2-8&smp=" <> url queueNew1Str <> "&e2e=" <> testE2ERatchetParamsStrUri)
      connectionRequest2queuesNew #==# ("simplex:/invitation#/?v=2-8&smp=" <> url (queueNewStr <> ";" <> queueNewStr) <> "&e2e=" <> testE2ERatchetParamsStrUri)
      connectionRequestV1 #== ("https://simplex.chat/invitation#/?v=1&smp=" <> url queueStr <> "&e2e=" <> testE2ERatchetParamsStrUri)
      connectionRequestClientDataEmpty #==# ("simplex:/invitation#/?v=2-8&smp=" <> url queueStr <> "&e2e=" <> testE2ERatchetParamsStrUri <> "&data=" <> url "{}")
      contactAddress #==# ("simplex:/contact#/?v=2-8&smp=" <> url queueStr)
      contactAddress #== ("https://simplex.chat/contact#/?v=2-8&smp=" <> url queueStr)
      contactAddress2queues #==# ("simplex:/contact#/?v=2-8&smp=" <> url (queueStr <> ";" <> queueStr))
      contactAddressNew #==# ("simplex:/contact#/?v=2-8&smp=" <> url queueNewStr)
      contactAddress2queuesNew #==# ("simplex:/contact#/?v=2-8&smp=" <> url (queueNewStr <> ";" <> queueNewStr))
      ...
      contactAddressClientData #==# ("simplex:/contact#/?v=2-8&smp=" <> url queueStr <> "&data=" <> url "{\"type\":\"group_link\", \"group_link_id\":\"abc\"}")
