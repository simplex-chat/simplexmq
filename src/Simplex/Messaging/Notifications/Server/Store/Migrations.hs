...
CREATE INDEX idx_tokens_push_provider_token ON tokens(push_provider, push_provider_token)
...
CREATE INDEX idx_token_ntfs_token_id ON token_ntfs(token_id);
CREATE INDEX idx_token_ntfs_subscription_id ON token_ntfs(subscription_id);
    |]
