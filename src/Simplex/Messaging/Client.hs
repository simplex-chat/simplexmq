...
proxyResolveName :: SMPClient -> NetworkRequestMode -> ProxiedRelay -> SimplexDomain -> ExceptT SMPClientError IO (Either ProxyClientError NameResolution)
...
directResolveName :: SMPClient -> NetworkRequestMode -> SimplexDomain -> ExceptT SMPClientError IO NameResolution
...
resolvedNameOrNotFound :: SimplexDomain -> NameResolution -> Bool
resolvedNameOrNotFound d NameResolution {registration} = case registration of
