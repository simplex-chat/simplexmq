...
INSERT INTO users (user_id) OVERRIDING SYSTEM VALUE VALUES (1);
...
CREATE TABLE connections(
  ...
  last_rcv_msg_hash BYTEA NOT NULL DEFAULT E'\\x',
  last_snd_msg_hash BYTEA NOT NULL DEFAULT E'\\x',
...
CREATE TABLE rcv_queues(
  ...
  rcv_queue_id INTEGER NOT NULL,
  rcv_primary INTEGER NOT NULL,
  replace_rcv_queue_id INTEGER NULL,
  delete_errors INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE messages(
  ...
  msg_body BYTEA NOT NULL DEFAULT E'\\x',
  msg_flags TEXT NULL,
...
CREATE TABLE snd_messages(
  ...
  internal_id INTEGER NOT NULL,
  internal_hash BYTEA NOT NULL,
  previous_msg_hash BYTEA NOT NULL DEFAULT E'\\x',
...
CREATE TABLE ntf_subscriptions(
  ...
  updated_by_supervisor INTEGER NOT NULL DEFAULT 0,
  created_at TIMESTAMP NOT NULL DEFAULT (now()),
  updated_at TIMESTAMP NOT NULL DEFAULT (now()),
...
CREATE TABLE commands(
  command_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  conn_id BYTEA NOT NULL REFERENCES connections ON DELETE CASCADE,
  host TEXT,
  port TEXT,
...
CREATE TABLE snd_message_deliveries(
  snd_message_delivery_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  conn_id BYTEA NOT NULL REFERENCES connections ON DELETE CASCADE,
  snd_queue_id INTEGER NOT NULL,
  internal_id INTEGER NOT NULL,
  failed INTEGER DEFAULT 0,
...
CREATE TABLE xftp_servers(
  xftp_server_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE rcv_files(
  rcv_file_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE rcv_file_chunks(
  rcv_file_chunk_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE rcv_file_chunk_replicas(
  rcv_file_chunk_replica_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE snd_files(
  snd_file_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE snd_file_chunks(
  snd_file_chunk_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE snd_file_chunk_replicas(
  snd_file_chunk_replica_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE snd_file_chunk_replica_recipients(
  snd_file_chunk_replica_recipient_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE deleted_snd_chunk_replicas(
  deleted_snd_chunk_replica_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  user_id INTEGER NOT NULL REFERENCES users ON DELETE CASCADE,
  xftp_server_id INTEGER NOT NULL REFERENCES xftp_servers ON DELETE CASCADE,
  replica_id BYTEA NOT NULL,
  replica_key BYTEA NOT NULL,
...
CREATE TABLE encrypted_rcv_message_hashes(
  encrypted_rcv_message_hash_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  conn_id BYTEA NOT NULL REFERENCES connections ON DELETE CASCADE,
  hash BYTEA NOT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT (now()),
  updated_at TIMESTAMP NOT NULL DEFAULT (now())
...
CREATE TABLE processed_ratchet_key_hashes(
  processed_ratchet_key_hash_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  conn_id BYTEA NOT NULL REFERENCES connections ON DELETE CASCADE,
  hash BYTEA NOT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT (now()),
  updated_at TIMESTAMP NOT NULL DEFAULT (now())
...
CREATE TABLE servers_stats(
  servers_stats_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  servers_stats TEXT,
...
CREATE TABLE ntf_tokens_to_delete(
  ntf_token_to_delete_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  ntf_host TEXT NOT NULL,
  ntf_port TEXT NOT NULL,
  ntf_key_hash BYTEA NOT NULL,
