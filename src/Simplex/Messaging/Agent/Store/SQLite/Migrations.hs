...
import Simplex.Messaging.Agent.Store.SQLite.Migrations.M20230903_connection_needs_sub
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("m20230903_connection_needs_sub", m20230903_connection_needs_sub, Just down_m20230903_connection_needs_sub)
  ]
