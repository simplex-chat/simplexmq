...
import Simplex.Messaging.Agent.Store.SQLite.Migrations.M20230615_ratchet_resync
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("m20230615_ratchet_resync", m20230615_ratchet_resync, Just down_m20230615_ratchet_resync)
  ]
