...
module Simplex.Messaging.Agent.Store.SQLite.Migrations.M_20210101_initial where

import Database.SQLite.Simple.QQ (sql)
import Simplex.Messaging.Agent.Store.SQLite.Migrations.Types (SchemaMigration (..))

m_20210101_initial :: SchemaMigration
m_20210101_initial =
  SchemaMigration
    { name = "20210101_initial",
      up =
        [sql|
      ...
      down =
        [sql|
          DROP TABLE messages;
          DROP TABLE rcv_messages;
          DROP TABLE snd_messages;
          DROP TABLE connections;
          DROP TABLE rcv_queues;
          DROP TABLE snd_queues;
          DROP TABLE servers;
        |]
    }
