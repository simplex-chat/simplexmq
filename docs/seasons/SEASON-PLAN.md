...
<p align="center">
  <strong>Season-based development roadmap for the GoChat encrypted web support messenger.</strong><br>
...
6. **Project name:** GoChat (ecosystem: SimpleGo, GoRelay, GoChat)
